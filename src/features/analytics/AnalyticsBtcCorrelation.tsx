...
export function AnalyticsBtcCorrelation() {
  ...
  const filtered = search.trim()
    ? sorted.filter((a) => a.symbol.toUpperCase().includes(search.trim().toUpperCase()))
    : sorted;
      ...
      <div className="mb-5 flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0 flex-wrap">
          <input
            ...
            onFocus={(e) => (e.currentTarget.style.borderColor = "oklch(0.72 0.18 248 / 35%)")}
          ...
          {PERIODS.map((d) => (
            <button
              key={d}
              type="button"
              onClick={() => { setLookbackDays(d); setPage(0); }}
              style={{
                fontFamily: "var(--font-mono)",
                fontSize: "0.6rem",
        ...
        <>
          ...
          {totalPages > 1 && (
            <div
              ...
              style={{ paddingTop: 10, borderTop: "1px solid oklch(1 0 0 / 6%)" }}
            >
              <span
                style={{
                  fontFamily: "var(--font-mono)",
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: "4px 12px",
                    background: "transparent",
                    color: page >= totalPages - 1 ? "oklch(0.28 0 0)" : "oklch(0.55 0 0)",
                    transition: "color 0.12s, border-color 0.12s",
                  }}
                >
                  Next →
